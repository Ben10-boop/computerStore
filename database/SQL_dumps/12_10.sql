...
--
-- Host: 127.0.0.1
-- Generation Time: 2021 m. Grd 10 d. 23:24
...
--
-- Sukurta duomenų struktūra lentelei `adresas`
--
...
--
-- Sukurta duomenų kopija lentelei `adresas`
--
...
--
-- Sukurta duomenų struktūra lentelei `apmokejimas`
--
...
--
-- Sukurta duomenų struktūra lentelei `banko_korteles`
--
...
--
-- Sukurta duomenų struktūra lentelei `garantijos`
--
...
--
-- Sukurta duomenų struktūra lentelei `garantijos_tipas`
--
...
--
-- Sukurta duomenų kopija lentelei `garantijos_tipas`
--
...
--
-- Sukurta duomenų struktūra lentelei `kainos`
--
...
--
-- Sukurta duomenų kopija lentelei `kainos`
--

INSERT INTO `kainos` (`id`, `pradzios_data`, `pabaigos_data`, `suma`, `prekes_id`, `created_at`, `updated_at`) VALUES
(1, '2021-10-05', '2022-06-18', '10', 1, NULL, NULL),
(2, '0000-00-00', '0000-00-00', '15', 2, NULL, NULL),
(3, '0000-00-00', '0000-00-00', '30', 3, NULL, NULL),
(5, '0000-00-00', '0000-00-00', '56', 5, NULL, NULL);
...
(1, 'Žaidimai', 'kompiuteriniai zaidimai', NULL, NULL),
(2, 'Kompiuteriai', 'komp', NULL, NULL),
...
--
-- Sukurta duomenų struktūra lentelei `pareigos`
--
...
--
-- Sukurta duomenų kopija lentelei `pareigos`
--
...
--
-- Sukurta duomenų struktūra lentelei `paskyros_busenos`
--
...
--
-- Sukurta duomenų kopija lentelei `paskyros_busenos`
--
...
--
-- Sukurta duomenų struktūra lentelei `prekes_kategorijos`
--
...
--
-- Sukurta duomenų kopija lentelei `prekes_kategorijos`
--

INSERT INTO `prekes_kategorijos` (`kategorijos_id`, `prekes_id`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, NULL),
(1, 2, NULL, NULL),
(1, 4, NULL, NULL),
(1, 5, NULL, NULL),
...
--
-- Sukurta duomenų struktūra lentelei `statusas`
--
...
--
-- Sukurta duomenų kopija lentelei `statusas`
--
...
(13, 'user', NULL, 'admin@gmail.com', '2021-12-08 09:23:57', '$2y$10$vSeFYGuQ9cW3moHgtEhqPe/Wq8WsAsqMeDeTfJzMVZdiUAwD7zMZ6', NULL, '2021-12-07 08:13:56', '2021-12-08 09:23:57', 'admin', NULL, NULL, NULL, NULL, 'užblokuotas', 'administratorius', NULL, NULL, NULL, NULL),
...
--
-- Sukurta duomenų struktūra lentelei `uzsakymo_preke_s`
--
